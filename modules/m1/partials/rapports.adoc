 ...
 - [[[Grigoryan]]] Grigoryan Mariam, _Modélisation de la qualité d'air dans des bâtiments et application au covid-19_, link:http://www.alsace.cnrs.fr[Cnrs Delegation Alsace], link:https://master-csmi.github.io/project-csmi-2021-covid19/covid19/1.0.0/mariam/index.html[Grigoryan-Mariam.pdf], link:{attachmentsdir}/Mariam_slides.pdf[Grigoryan-Mariam-slides.pdf]

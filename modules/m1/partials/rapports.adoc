 ...
 - [[[DeRose]]] De Rose Stève, _Modélisation de la transmission aéroportéedu covid-19_, link:http://www.alsace.cnrs.fr[Cnrs Delegation Alsace], link:https://github.com/master-csmi/project-csmi-2021-covid19/blob/develop/docs/modules/ROOT/pages/steve/airflow.adoc[De Rose-Stève Antora],  link:{attachmentsdir}/++De Rose-Stève-slides.pdf++[De Rose-Stève-slides.pdf] 
